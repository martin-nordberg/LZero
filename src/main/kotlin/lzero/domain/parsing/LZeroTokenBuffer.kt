 ...
 */
internal interface LZeroTokenBuffer {
     ...
     */
    fun consumeWhen(vararg tokenTypes: ELZeroTokenType): Boolean
     ...
     */
    fun hasLookAhead(tokenType: ELZeroTokenType): Boolean
